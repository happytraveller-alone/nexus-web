    ...
    return (
      <button
        ...
        className="
          ...
          shadow-[0_0_20px_rgba(60,127,245,0.4)]
          hover:shadow-[0_0_30px_rgba(60,127,245,0.6)]
    ...
    >
      <div className="flex items-center justify-between px-4 py-3 border-b border-border-subtle">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 flex items-center justify-center bg-[#3C7FF5] rounded-lg">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="
                ...
                shadow-[0_0_15px_rgba(60,127,245,0.3)]
                hover:shadow-[0_0_20px_rgba(60,127,245,0.5)]
